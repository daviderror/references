...
HD_PWD='/media/shimko/CEF0BAC0F0BAADD9/workspace/references/freertos_mastering/fpga/freertos_mastering.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log freertos_mastering_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source freertos_mastering_wrapper.tcl -notrace

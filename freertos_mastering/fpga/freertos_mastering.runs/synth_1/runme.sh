...
HD_PWD='/media/shimko/CEF0BAC0F0BAADD9/workspace/references/freertos_mastering/fpga/freertos_mastering.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log freertos_mastering_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source freertos_mastering_wrapper.tcl

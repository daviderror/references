...
//Date        : Sat Feb 12 16:42:33 2022
//Host        : simko-PC running 64-bit Ubuntu 18.04.6 LTS
//Command     : generate_target freertos_mastering.bd
//Design      : freertos_mastering
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "freertos_mastering,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=freertos_mastering,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "freertos_mastering.hwdef" *) 
module freertos_mastering
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
    DDR_0_ck_n,
  ...
  freertos_mastering_processing_system7_0_0 processing_system7_0

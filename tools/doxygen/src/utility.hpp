 ...
 */
/**
 * \brief Five constants.
 *
 * These five constants represent the five.
 */
#define MEW2KING  1
#define ARMADA    2
#define HUNGRYBOX 3
...
/**
 * \brief Multiplies all the  together.
 *
 * This function just multiplies the five  constants together.
 *
 * \return The product of the five numbers.
 */
int battleOfTheFives();
